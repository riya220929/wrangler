...
public enum TokenType implements Serializable {
   ...
   * This type handles data size values with appropriate unit conversions.
   */
  BYTE_SIZE,

  /**
   * Represents the enumerated type for time duration values (e.g., "100ms", "5s").
   * This type handles time duration values with appropriate unit conversions.
   */
  TIME_DURATION
}
